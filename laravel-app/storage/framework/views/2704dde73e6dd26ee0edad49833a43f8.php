        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="barcode_prefix"
                    value="<?php echo e($settings['barcode_prefix'] ?? '20'); ?>">
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="number" class="form-control" name="barcode_length"
                    value="<?php echo e($settings['barcode_length'] ?? 12); ?>">
            </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <input type="number" name="label_width" class="form-control" min="20"
                value="<?php echo e($settings['label_width'] ?? 50); ?>">
        ...
        <div class="col-md-3">
            ...
            <input type="number" name="label_height" class="form-control" min="15"
                value="<?php echo e($settings['label_height'] ?? 30); ?>">
        ...
        <div class="col-md-3">
            ...
            <input type="number" name="label_default_quantity" class="form-control" min="1"
                value="<?php echo e($settings['label_default_quantity'] ?? 1); ?>">
    ...
    <div class="mt-4">
        ...
        <div class="form-check form-switch mb-2">
            ...
            <input type="checkbox" class="form-check-input" name="label_show_name" value="1"
                <?php if(($settings['label_show_name'] ?? 1) == 1): echo 'checked'; endif; ?>>
        ...
        <div class="form-check form-switch mb-2">
            ...
            <input type="checkbox" class="form-check-input" name="label_show_price" value="1"
                <?php if(($settings['label_show_price'] ?? 1) == 1): echo 'checked'; endif; ?>>
        ...
        <div class="form-check form-switch mb-2">
            ...
            <input type="checkbox" class="form-check-input" name="label_show_barcode" value="1"
                <?php if(($settings['label_show_barcode'] ?? 1) == 1): echo 'checked'; endif; ?>>
        ...
        <div class="form-check form-switch mb-2">
            ...
            <input type="checkbox" class="form-check-input" name="label_show_code" value="1"
                <?php if(($settings['label_show_code'] ?? 1) == 1): echo 'checked'; endif; ?>>
        ...
        <div class="form-check form-switch">
            ...
            <input type="checkbox" class="form-check-input" name="label_show_unit" value="1"
                <?php if(($settings['label_show_unit'] ?? 0) == 1): echo 'checked'; endif; ?>>
...
<?php /**PATH C:\Users\Ali\Documents\Sales-Management-System\laravel-app\resources\views/settings/tabs/barcode.blade.php ENDPATH**/ ?>