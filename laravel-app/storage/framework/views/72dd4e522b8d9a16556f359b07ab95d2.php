                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="جستجوی دسته‌بندی...">
                        </div>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-edit').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    document.getElementById('editCategoryForm').action = '/categories/' + this
                        .dataset.id;
            ...
            document.querySelectorAll('.btn-delete').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    document.getElementById('deleteCategoryForm').action = '/categories/' + this
                        .dataset.id;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali\Documents\Sales-Management-System\laravel-app\resources\views/categories/index.blade.php ENDPATH**/ ?>