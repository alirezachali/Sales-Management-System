...
@section('title', 'چیدمان و مدیریت محصولات انبار')

@section('content')
    <div class="container-fluid">
        <livewire:warehouses.qr-code-manager />
    </div>
...
@section('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', initQrJalaliPicker);
        document.addEventListener('livewire:init', () => {
            initQrJalaliPicker();
            Livewire.hook('morph.updated', initQrJalaliPicker);
        });
    </script>
@endsection
