...
class SettingsManager extends Component
{
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------|
    |                     تغییر زبان برنامه به‌صورت زنده                  |
    |--------------------------------------------------------------------|
    | با انتخاب از dropdown زبان در صفحه‌ی تنظیمات، فوراً در تنظیمات       |
    | ذخیره و روی برنامه اعمال می‌شود (همان رفتار کلیک روی پرچم در        |
    | منوی ناوبری). پس از آن صفحه با زبان جدید رندر می‌شود.             |
    */
    public function changeLanguage(string $locale): void
    {
        ...
        session()->flash('success', 'زبان برنامه با موفقیت تغییر کرد. ('
            . ($locale === 'fa' ? 'فارسی' : 'English') . ')');

        // صفحه با زبان تازه‌شده دوباره رندر می‌شود تا برچسب‌ها به‌روز شوند
